                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Image.asset(
                          'assets/images/Sri_Sai_Ram_Engineering_College_logo.png',
                          width: 150.0,
                          height: 150.0,
                          fit: BoxFit.cover,
                        ),
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'fsr0ovi3' /* Or use a social account to log... */,
                                                  ),
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'tanqrn1h' /* Or use a social account to cre... */,
                                                    ),
